...
const Footer = () => {
  return (
    <footer className="bg-white border-t border-border/80">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="py-16">
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-8">
            <div className="col-span-1 md:col-span-1 lg:col-span-1">
              <Link to="/" className="text-xl font-semibold tracking-tight text-foreground">
                <span className="text-primary">Rappro</span>Invoice
              </Link>
              <p className="mt-4 text-sm text-muted-foreground max-w-xs">
                Your streamlined solution for invoice management and reconciliation.
              </p>
        ...
        <div className="border-t border-border/50 py-8">
          <p className="text-sm text-center text-muted-foreground">
            &copy; {new Date().getFullYear()} RapproInvoice. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
